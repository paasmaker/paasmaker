...
function program1(depth0,data) {
  ...
  buffer += escapeExpression(stack1)
    + "</span>\n				";
  stack1 = helpers['if'].call(depth0, depth0.can_export, {hash:{},inverse:self.noop,fn:self.program(6, program6, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n				";
  stack1 = helpers['if'].call(depth0, depth0.can_import, {hash:{},inverse:self.noop,fn:self.program(8, program8, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n			</td>\n		</tr>\n	";
  return buffer;
  }
...
function program5(depth0,data) {
  ...
  var template = Handlebars.template, templates = Handlebars.templates = Handlebars.templates || {};
templates['error_block'] = template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [2,'>= 1.0.0-rc.3'];
helpers = helpers || Handlebars.helpers; data = data || {};
  var buffer = "", stack1, functionType="function", escapeExpression=this.escapeExpression, self=this;
...
function program3(depth0,data) {
  ...
  return "\n		<h4>Couldn't complete this request</h4>\n	";
  }
...
function program5(depth0,data) {
  ...
  buffer += "<div class=\"alert alert-block alert-error\">\n	<a href=\"#\" class=\"close\" data-dismiss=\"alert\">&times;</a>\n	";
  stack1 = helpers['if'].call(depth0, depth0.error_title, {hash:{},inverse:self.program(3, program3, data),fn:self.program(1, program1, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n	<ul>\n		";
  stack1 = helpers.each.call(depth0, depth0.errors, {hash:{},inverse:self.noop,fn:self.program(5, program5, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n	</ul>\n</div>";
  return buffer;
  });
...
function program8(depth0,data) {
  ...
  var template = Handlebars.template, templates = Handlebars.templates = Handlebars.templates || {};
templates['service_export'] = template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [2,'>= 1.0.0-rc.3'];
helpers = helpers || Handlebars.helpers; data = data || {};
  var buffer = "", stack1, functionType="function", escapeExpression=this.escapeExpression;
  ...
  buffer += "<ul class=\"breadcrumb\"></ul>\n\n<h1>Export service "
    + escapeExpression(((stack1 = ((stack1 = depth0.service),stack1 == null || stack1 === false ? stack1 : stack1.name)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + "</h1>\n\n<form method=\"POST\">\n\n	<button class=\"btn btn-success\">Export</button>\n</form>";
  return buffer;
  });
})();(function() {
  var template = Handlebars.template, templates = Handlebars.templates = Handlebars.templates || {};
templates['service_import'] = template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [2,'>= 1.0.0-rc.3'];
helpers = helpers || Handlebars.helpers; data = data || {};
  var buffer = "", stack1, functionType="function", escapeExpression=this.escapeExpression;


  buffer += "<ul class=\"breadcrumb\"></ul>\n\n<h1>Import into service "
    + escapeExpression(((stack1 = ((stack1 = depth0.service),stack1 == null || stack1 === false ? stack1 : stack1.name)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + "</h1>\n\n<form method=\"POST\">\n	<div class=\"file-uploader-widget\"></div>\n\n	<a class=\"btn btn-success job-action-button\" href=\"/service/import/"
    + escapeExpression(((stack1 = ((stack1 = depth0.service),stack1 == null || stack1 === false ? stack1 : stack1.id)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + "\">Import</a>\n</form>";
  return buffer;
  });
})();(function() {
