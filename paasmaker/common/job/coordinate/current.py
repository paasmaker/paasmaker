...
class CurrentVersionRequestJob(InstanceJobHelper):
	...
	@staticmethod
	def setup_version(configuration, application_version_id, callback, error_callback, parent=None):
		...
		configuration.get_database_session(got_database_session, error_callback)
