...
INSTANCE = Enum(['ALLOCATED', 'REGISTERED', 'STARTING', 'RUNNING', 'STOPPED', 'ERROR', 'SHUTDOWN'])
...
INSTANCE_CAN_START_STATES = [INSTANCE.ALLOCATED, INSTANCE.STOPPED]
...
INSTANCE_FINISHED_STATES = [INSTANCE.STOPPED, INSTANCE.SHUTDOWN]

# The possible instance type states.
INSTANCE_TYPE = Enum(['NEW', 'PREPARED', 'ERROR', 'READY'])

# Various classes of instance type states.
INSTANCE_TYPE_ERROR_STATES = [INSTANCE_TYPE.ERROR]
INSTANCE_TYPE_READY_STATES = [INSTANCE_TYPE.READY]
