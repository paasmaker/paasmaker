...
test_sets = {
	...
	paasmaker.pacemaker.controller.application: ['normal', 'application', 'controller', 'createdeleteapplication'],
	...
	paasmaker.pacemaker.controller.service: ['normal', 'service', 'controller', 'serviceimportexport'],
	...
	paasmaker.common.periodic.oldinstances: ['normal', 'periodic', 'oldinstances'],
