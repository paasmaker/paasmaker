...
if configuration.is_pacemaker():
	...
	routes.extend(paasmaker.pacemaker.controller.job.JobTreeController.get_routes(route_extras))
	...
	routes.extend(paasmaker.pacemaker.controller.service.ServiceImportController.get_routes(route_extras))
	...
	routes.extend(paasmaker.pacemaker.controller.node.NodeInstancesController.get_routes(route_extras))
